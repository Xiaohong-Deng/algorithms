...
tuple<size_t, int*> random_greedy(size_t node_count, size_t edge_count, unordered_map<int, vector<int>> neighbors, size_t num_iter=1);
...
tuple<size_t, int*> iterated_local_search(size_t node_count, size_t edge_count, const tuple<int, int> edges[], int mode=0, size_t num_iter=50, int threshold=500);
